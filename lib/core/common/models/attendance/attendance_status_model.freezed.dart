...
@AttendanceStatusConverter() AttendanceStatus get status; AttendanceModel? get attendance;
...
@useResult
$Res call({
@AttendanceStatusConverter() AttendanceStatus status, AttendanceModel? attendance
});
...
as AttendanceStatus,attendance: freezed == attendance ? _self.attendance : attendance // ignore: cast_nullable_to_non_nullable
as AttendanceModel?,
  ));
}
/// Create a copy of AttendanceStatusModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@AttendanceStatusConverter()  AttendanceStatus status,  AttendanceModel? attendance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttendanceStatusModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@AttendanceStatusConverter()  AttendanceStatus status,  AttendanceModel? attendance)  $default,) {final _that = this;
switch (_that) {
case _AttendanceStatusModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@AttendanceStatusConverter()  AttendanceStatus status,  AttendanceModel? attendance)?  $default,) {final _that = this;
switch (_that) {
case _AttendanceStatusModel() when $default != null:
return $default(_that.status,_that.attendance);case _:
  return null;
...
class _AttendanceStatusModel extends AttendanceStatusModel {
  const _AttendanceStatusModel({@AttendanceStatusConverter() required this.status, this.attendance}): super._();
