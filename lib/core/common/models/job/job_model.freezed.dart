...
mixin _$JobModel {
 ...
 String get jobId; String get jobTitle; String get customerName; String get customerPhone; String? get customerAddress; String get workerProfileUid; String? get workerName; String? get workerImage; String? get createdByProfileUid; String? get createdByName;@JsonKey(fromJson: _jobStatusFromJson, toJson: _jobStatusToJson) JobStatus get status; bool get requirePhotoOnStart; bool get requirePhotoOnComplete; bool get captureLocation; DateTime get createdAt; DateTime? get assignedAt; DateTime? get updatedAt; DateTime? get completedAt; List<String> get allowedActions; String? get lastMessage; DateTime? get lastMessageAt; String? get lastActivityType; String? get lastActivityMessage; DateTime? get lastActivityAt;
...
@useResult
$Res call({
 String jobId, String jobTitle, String customerName, String customerPhone, String? customerAddress, String workerProfileUid, String? workerName, String? workerImage, String? createdByProfileUid, String? createdByName,@JsonKey(fromJson: _jobStatusFromJson, toJson: _jobStatusToJson) JobStatus status, bool requirePhotoOnStart, bool requirePhotoOnComplete, bool captureLocation, DateTime createdAt, DateTime? assignedAt, DateTime? updatedAt, DateTime? completedAt, List<String> allowedActions, String? lastMessage, DateTime? lastMessageAt, String? lastActivityType, String? lastActivityMessage, DateTime? lastActivityAt
});
...
as JobStatus,requirePhotoOnStart: null == requirePhotoOnStart ? _self.requirePhotoOnStart : requirePhotoOnStart // ignore: cast_nullable_to_non_nullable
...
class _JobModel extends JobModel {
  const _JobModel({required this.jobId, required this.jobTitle, required this.customerName, required this.customerPhone, this.customerAddress, required this.workerProfileUid, this.workerName, this.workerImage, this.createdByProfileUid, this.createdByName, @JsonKey(fromJson: _jobStatusFromJson, toJson: _jobStatusToJson) required this.status, required this.requirePhotoOnStart, required this.requirePhotoOnComplete, required this.captureLocation, required this.createdAt, this.assignedAt, this.updatedAt, this.completedAt, required final  List<String> allowedActions, this.lastMessage, this.lastMessageAt, this.lastActivityType, this.lastActivityMessage, this.lastActivityAt}): _allowedActions = allowedActions,super._();
...
@override@JsonKey(fromJson: _jobStatusFromJson, toJson: _jobStatusToJson) final  JobStatus status;
