...
mixin _$AttendanceModel {
 ...
 int get id; String get accountUid; String get userUid; String get companyUid; String get status; DateTime get startAt; DateTime? get endAt; double get startLatitude; double get startLongitude; double? get endLatitude; double? get endLongitude; double? get workHours; String? get startAddress; String? get endAddress;
...
@useResult
$Res call({
 int id, String accountUid, String userUid, String companyUid, String status, DateTime startAt, DateTime? endAt, double startLatitude, double startLongitude, double? endLatitude, double? endLongitude, double? workHours, String? startAddress, String? endAddress
});
...
/// Create a copy of AttendanceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? accountUid = null,Object? userUid = null,Object? companyUid = null,Object? status = null,Object? startAt = null,Object? endAt = freezed,Object? startLatitude = null,Object? startLongitude = null,Object? endLatitude = freezed,Object? endLongitude = freezed,Object? workHours = freezed,Object? startAddress = freezed,Object? endAddress = freezed,}) {
...
as DateTime?,startLatitude: null == startLatitude ? _self.startLatitude : startLatitude // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String accountUid,  String userUid,  String companyUid,  String status,  DateTime startAt,  DateTime? endAt,  double startLatitude,  double startLongitude,  double? endLatitude,  double? endLongitude,  double? workHours,  String? startAddress,  String? endAddress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttendanceModel() when $default != null:
return $default(_that.id,_that.accountUid,_that.userUid,_that.companyUid,_that.status,_that.startAt,_that.endAt,_that.startLatitude,_that.startLongitude,_that.endLatitude,_that.endLongitude,_that.workHours,_that.startAddress,_that.endAddress);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String accountUid,  String userUid,  String companyUid,  String status,  DateTime startAt,  DateTime? endAt,  double startLatitude,  double startLongitude,  double? endLatitude,  double? endLongitude,  double? workHours,  String? startAddress,  String? endAddress)  $default,) {final _that = this;
switch (_that) {
case _AttendanceModel():
return $default(_that.id,_that.accountUid,_that.userUid,_that.companyUid,_that.status,_that.startAt,_that.endAt,_that.startLatitude,_that.startLongitude,_that.endLatitude,_that.endLongitude,_that.workHours,_that.startAddress,_that.endAddress);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String accountUid,  String userUid,  String companyUid,  String status,  DateTime startAt,  DateTime? endAt,  double startLatitude,  double startLongitude,  double? endLatitude,  double? endLongitude,  double? workHours,  String? startAddress,  String? endAddress)?  $default,) {final _that = this;
switch (_that) {
case _AttendanceModel() when $default != null:
return $default(_that.id,_that.accountUid,_that.userUid,_that.companyUid,_that.status,_that.startAt,_that.endAt,_that.startLatitude,_that.startLongitude,_that.endLatitude,_that.endLongitude,_that.workHours,_that.startAddress,_that.endAddress);case _:
  return null;
...
class _AttendanceModel extends AttendanceModel {
  const _AttendanceModel({required this.id, required this.accountUid, required this.userUid, required this.companyUid, required this.status, required this.startAt, this.endAt, required this.startLatitude, required this.startLongitude, this.endLatitude, this.endLongitude, this.workHours, this.startAddress, this.endAddress}): super._();
...
/// Create a copy of AttendanceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? accountUid = null,Object? userUid = null,Object? companyUid = null,Object? status = null,Object? startAt = null,Object? endAt = freezed,Object? startLatitude = null,Object? startLongitude = null,Object? endLatitude = freezed,Object? endLongitude = freezed,Object? workHours = freezed,Object? startAddress = freezed,Object? endAddress = freezed,}) {
