...
mixin _$AttendanceModel {
 ...
 int get id; String get status; DateTime get startAt; DateTime? get endAt; double? get workHours; String? get address;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,status,startAt,endAt,workHours,address);

@override
String toString() {
  return 'AttendanceModel(id: $id, status: $status, startAt: $startAt, endAt: $endAt, workHours: $workHours, address: $address)';
}
...
@useResult
$Res call({
 int id, String status, DateTime startAt, DateTime? endAt, double? workHours, String? address
});
...
/// Create a copy of AttendanceModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? startAt = null,Object? endAt = freezed,Object? workHours = freezed,Object? address = freezed,}) {
...
as DateTime?,workHours: freezed == workHours ? _self.workHours : workHours // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String status,  DateTime startAt,  DateTime? endAt,  double? workHours,  String? address)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AttendanceModel() when $default != null:
return $default(_that.id,_that.status,_that.startAt,_that.endAt,_that.workHours,_that.address);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String status,  DateTime startAt,  DateTime? endAt,  double? workHours,  String? address)  $default,) {final _that = this;
switch (_that) {
case _AttendanceModel():
return $default(_that.id,_that.status,_that.startAt,_that.endAt,_that.workHours,_that.address);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String status,  DateTime startAt,  DateTime? endAt,  double? workHours,  String? address)?  $default,) {final _that = this;
switch (_that) {
case _AttendanceModel() when $default != null:
return $default(_that.id,_that.status,_that.startAt,_that.endAt,_that.workHours,_that.address);case _:
  return null;
...
class _AttendanceModel extends AttendanceModel {
  const _AttendanceModel({required this.id, required this.status, required this.startAt, this.endAt, this.workHours, this.address}): super._();
...
/// Create a copy of AttendanceModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? startAt = null,Object? endAt = freezed,Object? workHours = freezed,Object? address = freezed,}) {
