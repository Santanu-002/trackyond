...
class VerifyOtpUseCase implements BaseUseCase<VerifyOtpEntity, VerifyOtpParams> {
  final IAuthRepository _repository;

  VerifyOtpUseCase(this._repository);

  @override
  Future<Either<AppFailure, VerifyOtpEntity>> call(VerifyOtpParams params) async {
