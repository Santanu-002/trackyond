...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,localId,jobId,senderUid,const DeepCollectionEquality().hash(content),type,const DeepCollectionEquality().hash(metadata),actionPerformed,createdByAuthorAt,createdAt,updatedAt,seenAt,deliveredAt,active,deleted);

@override
String toString() {
  return 'JobChatMessageModel(uid: $uid, localId: $localId, jobId: $jobId, senderUid: $senderUid, content: $content, type: $type, metadata: $metadata, actionPerformed: $actionPerformed, createdByAuthorAt: $createdByAuthorAt, createdAt: $createdAt, updatedAt: $updatedAt, seenAt: $seenAt, deliveredAt: $deliveredAt, active: $active, deleted: $deleted)';
}
...
/// Create a copy of JobChatMessageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? localId = freezed,Object? jobId = null,Object? senderUid = freezed,Object? content = null,Object? type = null,Object? metadata = freezed,Object? actionPerformed = freezed,Object? createdByAuthorAt = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? seenAt = freezed,Object? deliveredAt = freezed,Object? active = freezed,Object? deleted = freezed,}) {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,localId,jobId,senderUid,const DeepCollectionEquality().hash(_content),type,const DeepCollectionEquality().hash(_metadata),actionPerformed,createdByAuthorAt,createdAt,updatedAt,seenAt,deliveredAt,active,deleted);
