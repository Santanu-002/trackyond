...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,localId,jobId,senderUid,const DeepCollectionEquality().hash(content),type,const DeepCollectionEquality().hash(metadata),actionPerformed,createdByAuthorAt,createdAt,updatedAt,seenAt,deliveredAt,active,deleted,deletedByUid,deletedByUserType,const DeepCollectionEquality().hash(deletedFor),deletedAt,deletedByUserAt]);

@override
String toString() {
  return 'JobChatMessageModel(uid: $uid, localId: $localId, jobId: $jobId, senderUid: $senderUid, content: $content, type: $type, metadata: $metadata, actionPerformed: $actionPerformed, createdByAuthorAt: $createdByAuthorAt, createdAt: $createdAt, updatedAt: $updatedAt, seenAt: $seenAt, deliveredAt: $deliveredAt, active: $active, deleted: $deleted, deletedByUid: $deletedByUid, deletedByUserType: $deletedByUserType, deletedFor: $deletedFor, deletedAt: $deletedAt, deletedByUserAt: $deletedByUserAt)';
}
...
/// Create a copy of JobChatMessageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? localId = freezed,Object? jobId = null,Object? senderUid = freezed,Object? content = null,Object? type = null,Object? metadata = freezed,Object? actionPerformed = freezed,Object? createdByAuthorAt = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? seenAt = freezed,Object? deliveredAt = freezed,Object? active = freezed,Object? deleted = freezed,Object? deletedByUid = freezed,Object? deletedByUserType = freezed,Object? deletedFor = null,Object? deletedAt = freezed,Object? deletedByUserAt = freezed,}) {
...
switch (_that) {
case _JobChatMessageModel() when $default != null:
return $default(_that.uid,_that.localId,_that.jobId,_that.senderUid,_that.content,_that.type,_that.metadata,_that.actionPerformed,_that.createdByAuthorAt,_that.createdAt,_that.updatedAt,_that.seenAt,_that.deliveredAt,_that.active,_that.deleted,_that.deletedByUid,_that.deletedByUserType,_that.deletedFor,_that.deletedAt,_that.deletedByUserAt);case _:
  return orElse();
...
switch (_that) {
case _JobChatMessageModel():
return $default(_that.uid,_that.localId,_that.jobId,_that.senderUid,_that.content,_that.type,_that.metadata,_that.actionPerformed,_that.createdByAuthorAt,_that.createdAt,_that.updatedAt,_that.seenAt,_that.deliveredAt,_that.active,_that.deleted,_that.deletedByUid,_that.deletedByUserType,_that.deletedFor,_that.deletedAt,_that.deletedByUserAt);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,localId,jobId,senderUid,const DeepCollectionEquality().hash(_content),type,const DeepCollectionEquality().hash(_metadata),actionPerformed,createdByAuthorAt,createdAt,updatedAt,seenAt,deliveredAt,active,deleted,deletedByUid,deletedByUserType,const DeepCollectionEquality().hash(_deletedFor),deletedAt,deletedByUserAt]);
