...
class EmitChatMessageReceivedUseCase implements BaseUseCase<void, JobChatMessageEntity> {
  final IEventBusRepository _eventBus;

  EmitChatMessageReceivedUseCase(this._eventBus);

  @override
  Future<Either<AppFailure, void>> call(JobChatMessageEntity params) async {
