...
class SendMessageUseCase implements BaseUseCase<JobChatMessageEntity, SendMessageParams> {
  final IJobChatRepository _repository;

  SendMessageUseCase(this._repository);

  @override
  Future<Either<AppFailure, JobChatMessageEntity>> call(SendMessageParams params) {
