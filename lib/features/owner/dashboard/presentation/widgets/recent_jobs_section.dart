      ...
      child: Padding(
        ...
        child: Obx(
          () => ListView.separated(
            ...
            separatorBuilder: (context, index) => AppUIConstants.widgets.verticalBox$12,
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: context.theme.colorScheme.primaryContainer.withAlpha(50),
                        borderRadius: BorderRadius.circular(AppUIConstants.radius.radius$12),
                      ),
                      child: Icon(
                        job.isOngoing ? Icons.work_outline_rounded : Icons.task_alt_rounded,
                      ...
                      children: [
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            final pendingColor = isDark ? AppColors.dark.pending : AppColors.light.pending;
                            final completedColor = context.theme.colorScheme.tertiary;
                            final statusColor = job.isOngoing ? pendingColor : completedColor;
