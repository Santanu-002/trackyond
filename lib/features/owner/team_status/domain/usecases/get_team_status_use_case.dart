...
class GetTeamStatusUseCase
    implements BaseUseCase<TeamStatusEntity, GetTeamStatusParams> {
  final ITeamStatusRepository _repository;

  GetTeamStatusUseCase(this._repository);

  @override
  Future<Either<AppFailure, TeamStatusEntity>> call(
    GetTeamStatusParams params,
  ) async {
