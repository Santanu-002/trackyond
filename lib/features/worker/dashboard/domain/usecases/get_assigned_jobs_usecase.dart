...
class GetAssignedJobsUseCase implements BaseUseCase<List<JobEntity>, GetAssignedJobsParams> {
  final IJobRepository _repository;

  GetAssignedJobsUseCase(this._repository);

  @override
  Future<Either<AppFailure, List<JobEntity>>> call(GetAssignedJobsParams params) {
